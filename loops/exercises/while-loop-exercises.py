...
while starting_fuel_level > 5000 and starting_fuel_level < 30000:
...
while astronauts_aboard <= 7:
  astronauts_aboard = int(input("Enter the number of astronauts aboard:"))
...
if altitude >= 2000:
   ...
   message = "Failed to reach orbit"
print("The shuttle gained an altitude of", altitude, "km and has", starting_fuel_level, "kg of fuel left.", message)